use uuid::Uuid;
use crate::models::{Relation, CreateRelationPayload, GetRelationsParams, ApiResponse, User, UserAuthPayload, RelationStatus};
...
pub trait RelationServiceTrait: Send + Sync {
    ...
    async fn delete_relation(&self, id: Uuid) -> Result<ApiResponse<bool>, String>;
}
...
pub trait UserServiceTrait: Send + Sync {
    ...
    async fn delete_user(&self, id: Uuid) -> Result<ApiResponse<bool>, String>;
} 